...
export default function AnimeSlider({ anime = [], isLoading = false }) {
  ...
  const handleToggleAutoPlay = useCallback(() => {
    ...
    // Set interacting untuk mencegah geser selama 500ms setelah menekan tombol
  ...
  if (isLoading || !anime || anime.length === 0) {
    return (
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative w-full h-[450px] sm:h-[500px] md:h-[550px] lg:h-[600px] xl:h-[700px] overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-3xl bg-gray-100 shadow-2xl border border-gray-200 animate-pulse">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/50 sm:from-black/75 sm:via-black/55 sm:to-black/45" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent backdrop-blur-xs" />
        </div>
        ...
        <div className="relative h-full flex items-center">
          <div className="w-full px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
            <div className="max-w-[calc(100%-4rem)] sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl mx-auto sm:mx-0">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-5 leading-tight tracking-tight">
                {currentAnime?.title}
              </h1>
