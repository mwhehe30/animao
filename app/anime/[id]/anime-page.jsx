  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <section className='relative h-[70vh] md:h-[60vh] overflow-hidden'>
        ...
        />
        <div className='absolute inset-0 bg-linear-to-t from-background from-10% via-background/20 via-40% to-transparent to-90% backdrop-blur-xs sm:backdrop-blur-sm lg:backdrop-blur-md' />
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='flex flex-col md:flex-row gap-4 md:gap-8 md:items-end'>
              ...
              <div className='flex-1'>
                <div className='text-transparent bg-linear-to-r from-black via-indigo-400 to-black bg-clip-text text-shadow-xl text-shadow-white'>
